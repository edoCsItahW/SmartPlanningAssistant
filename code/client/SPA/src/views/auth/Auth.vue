...
export default defineComponent({
    data() {
        return {
            carousels: ["Smart", "Fast", "Secure", "Efficient"],
            form: {
                username: "",
                password: "",
        ...
        <div class="login-wrapper">
            ...
            <div class="login-left">
                ...
                <el-carousel class="login-left-carousel" direction="vertical" type="card"
                    ...
                    <el-carousel-item v-for="desc in carousels" :key="desc">
            ...
            <div class="login-right">
                ...
                <div class="login-right-wrapper">
                    ...
                    <el-space class="login-right-title" :size="20">
                        ...
                        <el-image class="login-right-logo" src="/src/assets/imgs/SPA_Brains.png" />

                        <h2 style="margin-right: 150px;">{{
                                form.operationType === OperationType.LOGIN ? "Login" : "Register"
                            }}</h2>
                    ...
                    <el-form class="login-form" :model="form" :rules="rules" ref="formRef"
                        ...
                        <el-form-item prop="username">
                            ...
                            <el-input v-model="form.username"
                                      placeholder="please input your username" maxlength="20"
                        ...
                        <el-form-item>
                            ...
                            <el-text class="description">By registering and logging in, you
                                acknowledge
                                that you have read and agree to our
                                <el-link type="primary" underline="never">User Agreement</el-link>
                                and
                                <el-link type="primary" underline="never">Privacy Policy</el-link>
                                .
                            </el-text>
                        ...
                        <div class="login-links">
                            ...
                            <el-link type="primary"
                                ...
                                {{
                                    form.operationType === OperationType.LOGIN ? "Create an account?" : "Already have an account?"
                                }}
                            </el-link>
